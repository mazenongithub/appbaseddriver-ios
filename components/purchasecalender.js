...
class PurchaseCalender {
    ...
    showicon() {
        ...
        if (this.state.purchasecalender) {
            return (
                <Text style={{ ...styles.generalButton, ...removeIcon }} onPress={() => { this.setState({ purchasecalender: false }) }}>X</Text>
            )
        } else {
            return (
                <Text style={{ ...styles.generalButton, ...dropIcon }} onPress={() => { this.setState({ purchasecalender: true }) }}>O </Text>
            )
        }
