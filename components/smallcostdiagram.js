...
// fill:#fdd726;stroke-width:0.5px;stroke:#231f20;stroke-miterlimit:10;
        ...
        const februarycosts = (cost) => {
            ...
            const label = (showlabel) => {
                if (showlabel) {
                    return (<G> <Path stroke="#231f20" strokeWidth="0.5" fill="#eebe88" d="M93.84,267.44v27.65a1.11,1.11,0,0,1-1.17,1.05h-79a1.11,1.11,0,0,1-1.17-1.05V272.88a.86.86,0,0,0,0-.28l-2.76-8.89a1.11,1.11,0,0,1,1.43-1.29l17,3.94.3,0H92.67A1.11,1.11,0,0,1,93.84,267.44Z" />
